...
public class InterProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 90, 30));
        ...
        getContentPane().add(jComboBox1_iva, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 170, -1));
        ...
        getContentPane().add(jComboBox2_categoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 200, 170, -1));
        ...
        getContentPane().add(jButton1_Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 90, 30));
    ...
    private void jButton1_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_GuardarActionPerformed
        ...
        if (txt_nombre.getText().equals("") || txt_cantidad.getText().equals("") || txt_precio.getText().equals("")) {
            ...
            //CONSULTA para ver si el producto existe↓↓
