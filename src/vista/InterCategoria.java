...
public class InterCategoria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 170, 40));
        ...
        jLabel1_wallpaper.setBackground(new java.awt.Color(240, 240, 240));
        jLabel1_wallpaper.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        jLabel1_wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondo3.jpg"))); // NOI18N
        jLabel1_wallpaper.setMaximumSize(new java.awt.Dimension(400, 200));
        jLabel1_wallpaper.setMinimumSize(new java.awt.Dimension(400, 200));
        jLabel1_wallpaper.setPreferredSize(new java.awt.Dimension(400, 200));
        getContentPane().add(jLabel1_wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 380, 170));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txt_descripcion.getText().isEmpty()) {
            ...
            if (!controlCategoria.existeCategoria(txt_descripcion.getText().trim())) {
                ...
                JOptionPane.showMessageDialog(null, "La categortia ya registrada en la base de datos");
            }
        }
        //limpiar campo
