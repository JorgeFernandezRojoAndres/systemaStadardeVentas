...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            Encabezado.getDefaultCell().setBorder(1);//quitar el borde de la tabla
            ...
            tablaCliente.getDefaultCell().setBorder(1);//quitar bordes
            //tamaño de las celdas
            ...
            //quitar bordes 
            cliente1.setBorder(1);
            cliente2.setBorder(1);
            cliente3.setBorder(1);
            cliente4.setBorder(1);
            ...
            tablaProducto.getDefaultCell().setBorder(1);
            //tamaño de celdas
            ...
            info.add("Total a pagar: " + InterFacturacion.txt_totalApagar.getText());
